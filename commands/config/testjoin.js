            ...
            .addFields([
                {
                    ...
                    value: (plugin?.enabled ? interaction.guild.translate("config/testjoin:ENABLED_YES_CONTENT", {
                ...
                },
                {
                    ...
                    value: (plugin?.mainMessage || interaction.guild.translate("config/testjoin:ENABLED_YES_CONTENT", {
                        prefix: interaction.guild.settings.prefix
                    }))
                },
                {
                    name: interaction.guild.translate("config/testleave:CHANNEL_TITLE"),
                    value: (plugin?.channel ? `<#${plugin.channel}>` : interaction.guild.translate("config/testjoin:CHANNEL_CONTENT", {
                        prefix: interaction.guild.settings.prefix
                    }))
                }
            ])
